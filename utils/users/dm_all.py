...
from utils.discord_api.discord_utils import get_headers, validate_token
...
def get_user_friends(token: str) -> List[Dict]:
    ...
    headers = {
        ...
        'x-super-properties': ''
    }
