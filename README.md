...
| **🛠️ Discord Tools** | Close All DMs | ✅ | Bulk DM management | Close all open direct messages at once, confirmation prompts |
...
| **🏗️ Server Tools** | Server Cloner | ✅ | Complete server duplication | Copy roles, channels, emojis, settings, structure, permissions |
...
| **⚙️ Settings Tools** | Language & Theme Spam | ✅ | Discord settings flooding | Language cycling, light/dark mode spam, mixed settings, automation |
